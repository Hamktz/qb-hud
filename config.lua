...
Config.MinimumSpeed = 190 -- Going Over This Speed Will Cause Stress
...
Config.Menu = {
    ...
    isshowCashModeChecked = false, -- isshowCashModeChecked
    isshowBankModeChecked = false, -- isshowBankModeChecked
